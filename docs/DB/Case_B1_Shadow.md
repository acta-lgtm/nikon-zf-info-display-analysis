...
| 136  | S41            | Open LCD monitor                                                             | S1         | Live View (with DP1)          | Off                                        |   E   | E / N / M |
| 137  | S1             | Press the DISP button                                                        | S1          | Live View (with DP1)          | Off                                        |   E   | E / N / M |
...
| 153  | S40            | Open LCD monitor                                                             | S1          | Live View (with DP1)          | Off                                        |   E   | E / N / M |
...
| 186  | S38            | In [CUSTOM SETTINGS MENU] > [d19 Custom monitor shooting display], un-check Display 5; <br>  Half-press shutter button | S1 | Live View (with DP1)          | Off |   E   | E / N / M |
| 187  | S1             | Power off, then on                                                           | S1          | Live View (with DP1)          | Off |   E   | E / N / M |
| 188  | S1             | In [CUSTOM SETTINGS MENU] > [d19 Custom monitor shooting display], select Display 5; <br> Half-press shutter button  | S1 | Live View (with DP1)          | Off |   E   | E / N / M |
...
| 226  | S0             | In [SETUP MENU] > [Limit monitor mode selection], <br> select ONLY "Automatic display switch", then exit | S17         | Live View (with DP1)          | Off                                        |   E   | E / N / M |
...
| 2    | S0            | Open LCD monitor                                              | S1          | Live View (with DP1)         | Off             |   E   | E / N / M |
